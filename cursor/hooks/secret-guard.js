#!/usr/bin/env node
// secret-guard.js — Cursor preToolUse (Write|StrReplace): block secret patterns in write content

const { readHookInput, block, extractWriteContent } = require('./hook-utils');
...
const SECRET_PATTERNS = [
  ...
  { name: 'GitHub PAT', re: /ghp_[A-Za-z0-9]{36,}/ },
  {
    ...
    re: /(?:api[_-]?key|password|secret)\s*[=:]\s*['"][^'"\s]{8,}['"]/i,
  },
];
